...
public class AdminController {
	...
	@RequestMapping(value = { "/administrator/anvandare/editUser" }, method = RequestMethod.GET)
	...
	@RequestMapping(value = "/administrator/anvandare/editUser", method = RequestMethod.POST)
