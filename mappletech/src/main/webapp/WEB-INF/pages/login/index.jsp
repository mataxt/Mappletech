			...
			<div class="row">
				<div class="col-md-offset-4 col-md-4 col-md-offset-4"
					...
					<div class="logo text-center">
						<h1>Mappletech</h1>
						<p>
							<span style="color: #eee">F�reningsplattform</span>
						</p>
						<p>&nbsp;</p>
					</div>
				</div>
					...
					<div class="col-md-offset-4 col-md-4 col-md-offset-4"
						...
						<form:form modelAttribute="uservm" id="user" class="form-signin"
							...
							<form:input path="username" id="inputUsername"
								class="form-control" placeholder="Anv�ndarnamn" required=""
								autofocus="true" />
                        ...
                        <a href="/login/glomt-losenord/">
                            <button type="submit" value="Submit"
								class="btn btn-sm btn-info btn-block">Gl�mt l�senord</button>
                        </a>
                        <br />
