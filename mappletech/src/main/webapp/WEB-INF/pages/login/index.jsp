...
<head>
<spring:url value="<%=request.getContextPath()%>/resources/UI/bootstrap/css/bootstrap.min.css" var="mappleTechCSS_bootst" />
<spring:url value="<%=request.getContextPath()%>/resources/UI/css/font-awesome.min.css" var="mappleTechCSS_font" />
<spring:url value="<%=request.getContextPath()%>/resources/UI/css/style.css" var="mappleTechCSS_style" />
<meta charset="utf-8">
