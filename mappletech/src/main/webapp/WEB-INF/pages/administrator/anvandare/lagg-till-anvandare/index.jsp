...
<title>Mappletech - Registrera ny användare</title>
...
<link
	...
	rel="stylesheet" type="text/css">
<link
	href="<%=request.getContextPath()%>../../UI/css/angular-extra-table.css"
	rel="stylesheet">
							...
							<form:form modelAttribute="uservm" class="form-register"
								...
								<div class="form-group ">
									...
									<form:input path="email" type="text" class="form-control"
										name="email" placeholder="Ex. namn@epost.se" maxlength="250" />
								...
								<div class="box-footer">
									<button type="submit" class="btn-lg btn btn-success"
										name="submit">Registrera ny användare</button>

									<span style="color: #00a65a"></span> <span
										style="color: #f56954"></span> <span style="color: #f56954"></span>
								</div>
