            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="container">
                            	...
                            	<form class="form-change" action="/admin/andra-anvandare/index.php" method="post">
                                  ...
                                  <div class="form-group">
                                     ...
                                     <select class="form-control" name="mail">
                                         <option value="Tvättstuga 1A">Tvättstuga 1A</option>
                                         <option value="Tvättstuga 2B">Tvättstuga 2B</option>
                                         <option value="Lokal 1280">Lokal 1280</option>
                        ...
                        <div class="row">
                        	<div class="col-md-offset-3 col-md-6 col-md-offset-3">
                  				 <button type="submit" class="btn-lg btn btn-success" name="facility">Boka anläggning</button>
                  			</div>
                        </div>
