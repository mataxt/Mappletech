                    ...
                    <div class="col-md-offset-4 col-md-4 col-md-offset-4" style="background:rgba(120, 120, 140, 0.5)">
                        <a href="#">
                            <div class="logo text-center">
                                <h1>Mappletech</h1>
                                <p><span style="color:#eee">Föreningsplattform</span></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="footer-contact-info light-red">
                                ...
                                <ul>
                                    <li><strong>2016-01-29: </strong>Just nu är det problem med avloppssystemen.</li>
                                </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                    	<div class="form-group">
                                            <select class="form-control select2dropdown" multiple="multiple" data-placeholder="VÃ¤lj kategori" style="width: 100%;">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea class="form-control" placeholder="UtfÃ¶rlig beskrivning" id="message" style="height:150px" required data-validation-required-message="Skriva in en utfÃ¶rlig beskrivning."></textarea>
                                    ...
                                    <div class="col-lg-12 text-center">
                                        <div id="success"></div>
                                        <button type="submit" class="btn btn-primary light-red">Skicka felanmälan</button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="footer-contact-info purple">
                                ...
                                <ul>
                                    <li><strong>2016-01-29: </strong>Just nu är det problem med avloppssystemen. Magnus har förstoppat rören. Avvaktar med mer information kring detta.</li>
                                </ul>
                                ...
                                <ul>
                                    <li><strong>2016-10-26: </strong>Just nu är det problem med internetförbindelsen. Det är beräknat vara klart kl 20:00.</li>
                                </ul>
                            </div>
                        </div>
